<script>
  ...
  let tailBadgeY = $derived(
    isHead ? -(BADGE_H + ARROW_LEN) * 2 - 4 : -(BADGE_H + ARROW_LEN),
  );
...
>
  ...
  {#if isWalk}
    ...
    />
    <polygon
      points="{badgeCenterX - 4},{isHead
        ? headBadgeY - 6
        : isTail
          ? tailBadgeY - 6
          : -6} {badgeCenterX + 4},{isHead
        ? headBadgeY - 6
        : isTail
          ? tailBadgeY - 6
          : -6} {badgeCenterX},{isHead ? headBadgeY : isTail ? tailBadgeY : 0}"
      fill="#fb923c"
    />
    <rect
  ...
  {#if isTail}
    ...
    />
    <polygon
      points="{badgeCenterX - 4},{isHead ? headBadgeY - 6 : -6} {badgeCenterX +
        4},{isHead ? headBadgeY - 6 : -6} {badgeCenterX},{isHead
        ? headBadgeY
        : 0}"
      fill="#c084fc"
    />
