<script>
    ...
    import {
        ...
        resetTraversal,
        setTraversalSpeed,
    } from "../../stores/tree/avlTraversal.js";
    ...
    $effect(() => {
        registerHistoryHandlers(getSnapshotAVL, applySnapshotAVL);
    });

    // Navigating away from the AVL page unmounts this component, but the
    ...
    onMount(() => {
        ...
        window.addEventListener("avl:insert", onInsertEvent);
        return () => {
            window.removeEventListener("avl:insert", onInsertEvent);
        };
    });
    ...
    <div class="actions">
        ...
        <Tooltip text="Search">
            <button
                ...
                disabled={$avlIsEmpty || !searchInput.trim()}
            >
        ...
        <Tooltip text="Step back">
            <button
                ...
                onclick={stepBack}
                disabled={$avlIsEmpty || $traversalState.playing || $traversalState.index <= -1}
            >
                <svg width="14" height="14" viewBox="0 0 14 14" fill="none">
...
{#if showInsert}
    ...
    <div class="modal-overlay" onmousedown={() => (showInsert = false)}>
        <div class="modal" onmousedown={(e) => e.stopPropagation()}>
            ...
            <div class="modal-body">
                <div class="field">
                    <label for="avl-insert-value">Value</label>
                    <input
                        id="avl-insert-value"
